...
all: hypervisor devicemodel tools
	@cat $(HV_CFG_LOG)
	@python3 hypervisor/scripts/gen_acrn_deb.py $(BOARD) $(SCENARIO) $(ROOT_OUT) $(FULL_VERSION)
...
board_inspector:
	@python3 hypervisor/scripts/gen_acrn_deb.py $(ROOT_OUT) $(FULL_VERSION) board_inspect
