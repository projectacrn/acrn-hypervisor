...
- ACRN-Kernel (Service VM kernel): **release_2.2 (5.4.49-PKT-200203T060100Z)**
...
#. Install IASL in Ubuntu for User VM launch
   ACRN uses iasl to parse User VM ACPI information.
   The original iasl in Ubuntu 18.04 is too old; update it using the following steps:
