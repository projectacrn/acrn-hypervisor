...
#define	VM4_CONFIG_CPU_AFFINITY		(AFFINITY_CPU(1U))
#define	VM5_CONFIG_CPU_AFFINITY		(AFFINITY_CPU(1U))
#define	VM6_CONFIG_CPU_AFFINITY		(AFFINITY_CPU(1U))
#define	VM7_CONFIG_CPU_AFFINITY		(AFFINITY_CPU(1U))
